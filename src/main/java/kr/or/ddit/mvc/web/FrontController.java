...
public class FrontController extends HttpServlet{
	...
	@Override
		...
		/*
		 * if(uri.equals("mvc/userList.do")) { controller = new UserListController();
		 * controller.execute(req,resp); } else if(uri.equals("/mvc/memberList.do")) {
		 * controller = new MemberListController(); controller.execute(req,resp); }
		 */
